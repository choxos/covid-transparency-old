...
**Results:** The total number of COVID-19-related articles was 175 550, of which we were able to retrieve full texts of 132 618 (75.6%) articles from the database Of those, 87.0%, (95% CI: 86.8%--87.2%) provided conflicts of interest disclosure and 68.9% (95% CI: 68.7%--69.2%) funding disclosure and 3.6%, (95% CI: 3.5%--3.7%) had registered protocol. 8.7% (95% CI: 8.6%--8.9%) of studies shared raw data and 3.1% (95% CI: 3.0%--3.2%) of studies shared code. Transparent practices were more common in articles published in 2021 than in 2020.
...
We used R v4.1.2 [@R-base] for searches, data handling, analysis and reporting. The searches and data export from the Europe PMC were conducted with the europepmc package [@europepmc]. Indicators of transparent practices from the available full-texts were extracted with the rtransparent package [@rtransparent]. Trends over time in transparent practices by journal- and article-related information were reported using descriptive tabulations and graphical illustrations, for instance using the ggplot2 package [@ggplot2]. We used the numbers for sensitivity and specificity of the rtransparent package (3) to generate 95% confidence intervals (CIs) for our prevalence estimates of the transparency practices with the epiR package [@epiR]. We also provided monthly trends for transparency practices, to check whether there were any trends in transparent practices over time. We used Chi-square for comparing adherence to practices between years and the Wilcoxon rank sum test to test whether there was a relationship of transparency practices with citations to articles and JIFs. The thorough system information for the analysis is available in Appendix 2.

# Results

The total number of COVID-19-related articles (open access and non-open access) was 175 550, of which 133 470 (76.0%) were accessible as open-access in the EPMC. However, 852 (0.6%) were not downloadable because of technical issues and thus were excluded from our analyses. Of those 132618 remaining articles, 47550 were published in 2020, 75857 in 2021, and 9211 in the first two months of 2022 (Appendix 3).
...
A total of 38383 articles were published in journals with JIF. Papers that had a COI disclosure, funding statement and were registered tend to be published in journals with lower JIF (P = 0.003, \< 0.001, and = 0.007, respectively). Detailed information is illustrated in Table 1.

Table 1. Citations and journal impact factor by transparent practices.
...
One of eleven (9%, n=11890) articles did not adhere to any of the five transparency practices, 24.0% (n=31 844) adhered to one, 55.9% (n=74085) adhered to two and 9.1% (n=12 110) adhered to three. 2.0% (n=2644) articles showed adherence to four transparent practices, and less than 0.1% of articles (n=45) had used all five practices. 

Figure 1 shows the monthly trend for three transparent practices. All practices showed increasing monthly trend. However, the increasing trends for COI and funding disclosures were steeper compared to three other practices.
