...
Transparency is crucial to ensure the credibility of science and enable its assessment. It has been argued that open science, including transparency practices such as the ones we investigated here, have helped to fight pandemic globally [@besançon2021; @vuong2022]. However, your findings showed suboptimal adherence to data and code sharing and pre-registeration in COVID-19 related research, whilst majority of researchers had adhered to disclose funding and conflicts of interests related to their COVID-19 related medical research. Stronger commitment to open science practices, particularly to preregistration, data and code sharing, is needed from all stakeholders.
